/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cae4f86e6921325076348f5426a796ca)
// Runtime types generated with workerd@1.20260212.0 2026-02-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameOrchestrator" | "ScriptAgent" | "TextureAgent";
	}
	interface Env {
		TEXTURE_BUCKET: R2Bucket;
		R2_PUBLIC_BASE_URL: "http://localhost:8787";
		OPENAI_API_KEY: string;
		REPLICATE_API_TOKEN: string;
		GameOrchestrator: DurableObjectNamespace<import("./src/index").GameOrchestrator>;
		ScriptAgent: DurableObjectNamespace<import("./src/index").ScriptAgent>;
		TextureAgent: DurableObjectNamespace<import("./src/index").TextureAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_BASE_URL" | "OPENAI_API_KEY" | "REPLICATE_API_TOKEN">> {}
}
